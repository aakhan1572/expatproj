...
class Expatad(models.Model):
    ...
    countrycode = models.ForeignKey(Countrycode ,default='India',  on_delete=models.CASCADE)
    purpose = models.ForeignKey(Purpose , on_delete=models.CASCADE)
    citycode = models.ForeignKey(CityCode ,  default='Hyderabad',on_delete=models.CASCADE)
    ...
    areameasurement = models.CharField(max_length=40,default='Sq. ft.')
